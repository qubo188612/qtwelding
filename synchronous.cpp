...
bool Synchronous::Scantrace_to_Weldtrace(std::vector<Scan_trace_line> scan_trace,std::vector<Eigen::Vector3d> &weld_trace)
{
    std::vector<Eigen::Vector3d> reweld_trace;
