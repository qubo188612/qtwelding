...
//美化界面
    ...
    ui->alg0_99_threshold->setStyleSheet(FONT_EDIT_INFO);
    ui->alg100_othersave->setStyleSheet(FONT_EDIT_INFO);
    ui->alg100_threshold->setStyleSheet(FONT_EDIT_INFO);
    ui->alg101_othersave->setStyleSheet(FONT_EDIT_INFO);
    ui->alg101_threshold->setStyleSheet(FONT_EDIT_INFO);
    ui->alg102_othersave->setStyleSheet(FONT_EDIT_INFO);
    ui->alg102_threshold->setStyleSheet(FONT_EDIT_INFO);
    ui->alg103_othersave->setStyleSheet(FONT_EDIT_INFO);
    ui->alg103_threshold->setStyleSheet(FONT_EDIT_INFO);
    ui->alg104_othersave->setStyleSheet(FONT_EDIT_INFO);
    ui->alg104_threshold->setStyleSheet(FONT_EDIT_INFO);
    ui->alg105_othersave->setStyleSheet(FONT_EDIT_INFO);
    ui->alg105_threshold->setStyleSheet(FONT_EDIT_INFO);
    ui->alg106_othersave->setStyleSheet(FONT_EDIT_INFO);
    ui->alg106_threshold->setStyleSheet(FONT_EDIT_INFO);
    ui->alg107_othersave->setStyleSheet(FONT_EDIT_INFO);
    ui->alg107_threshold->setStyleSheet(FONT_EDIT_INFO);
    ui->alg108_othersave->setStyleSheet(FONT_EDIT_INFO);
    ui->alg108_threshold->setStyleSheet(FONT_EDIT_INFO);
    ui->bmpstepEdit->setStyleSheet(FONT_EDIT_INFO);
    ui->cambuildBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->cam_fps->setStyleSheet(FONT_EDIT_INFO);
    ui->cam_height->setStyleSheet(FONT_EDIT_INFO);
    ui->cam_view_height->setStyleSheet(FONT_EDIT_INFO);
    ui->cam_view_width->setStyleSheet(FONT_EDIT_INFO);
    ui->cam_width->setStyleSheet(FONT_EDIT_INFO);
    ...
    ui->connectcameraBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->dX->setStyleSheet(FONT_EDIT_INFO);
    ui->dY->setStyleSheet(FONT_EDIT_INFO);
    ui->dZ->setStyleSheet(FONT_EDIT_INFO);
    ui->initTab2Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->initTab3Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->initTab4Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->initTab5Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->initTab6Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->initTab7Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->initTab8Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->initTab9Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->initTab10Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->IPadd->setStyleSheet(FONT_EDIT_INFO);
    ui->othersaveTab2Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->othersaveTab3Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->othersaveTab4Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->othersaveTab5Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->othersaveTab6Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->othersaveTab7Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->othersaveTab8Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->othersaveTab9Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->othersaveTab10Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->psetBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->pshowBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->readTab1Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->readTab2Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->readTab3Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->readTab4Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->readTab5Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->readTab6Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->readTab7Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->readTab8Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->readTab9Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->readTab10Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->robotport->setStyleSheet(FONT_EDIT_INFO);
    ui->robotsetBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->robot_ip->setStyleSheet(FONT_EDIT_INFO);
    ui->saveavishowBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->savebmpshowBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->savebmpstepBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->setcamsizeBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->setdposBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->stepupBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->tab2ZoomBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->tab3ZoomBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->tab7ZoomBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->tab8ZoomBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->tab10ZoomBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->taskclearBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->tasknum->setStyleSheet(FONT_EDIT_INFO);
    ui->tasknumsetBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->tasknumshowBtn->setStyleSheet(FONT_BUTTON_INFO);
    ui->writeTab1Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->writeTab2Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->writeTab3Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->writeTab4Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->writeTab5Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->writeTab6Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->writeTab7Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->writeTab8Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->writeTab9Btn->setStyleSheet(FONT_BUTTON_INFO);
    ui->writeTab10Btn->setStyleSheet(FONT_BUTTON_INFO);
