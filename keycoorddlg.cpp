...
//美化界面
    ...
    ui->comboBox_cpointo->setStyleSheet(FONT_COMBOBOX_INFO);
    ui->comboBox_cpointx->setStyleSheet(FONT_COMBOBOX_INFO);
    ui->comboBox_pointo->setStyleSheet(FONT_COMBOBOX_INFO);
    ui->comboBox_pointx->setStyleSheet(FONT_COMBOBOX_INFO);
    ui->name->setStyleSheet(FONT_EDIT_INFO);
